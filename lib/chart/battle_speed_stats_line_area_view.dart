...
class BattleSpeedStatsLineAreaView extends StatefulWidget {
  BattleSpeedStatsLineAreaView({required this.datas ,required this.aveDatas, required this.maxCount});
  List<BattleSpeedModel> datas = []; // 个人训练的数据
  List<BattleSpeedModel> aveDatas = []; // 平均时间的数据
  int maxCount = 3;
  @override
  State<BattleSpeedStatsLineAreaView> createState() => _BattleSpeedStatsLineAreaViewState();
}

class _BattleSpeedStatsLineAreaViewState extends State<BattleSpeedStatsLineAreaView> {
  @override
  Widget build(BuildContext context) {
    return widget.datas.length > 0
        ?
    Container(
      margin: EdgeInsets.only(top: 24,right:16,bottom: 50 ),
      child: SfCartesianChart(
        ...
        series: <CartesianSeries<BattleSpeedModel, String>>[
          AreaSeries(
              ...
              // color: Colors.green,
              borderColor: Color.fromRGBO(241, 18, 18, 1),
              // 设置边界线颜色
              borderWidth: 1,
              // 设置边界线宽度
              // 这里是选中的折线的颜色
              ...
              markerSettings: MarkerSettings(
                ...
                // 设置数据点为圆形
                color:  Color.fromRGBO(241, 18, 18, 1),
                // 设置数据点颜色
                height: 3,
                // 设置数据点高度
                width: 3, // 设置数据点宽度
          ...
          AreaSeries(
              ...
              borderColor: Color.fromRGBO(65, 52, 249, 1.0),
              // 设置边界线颜色
              borderWidth: 1,
              markerSettings: MarkerSettings(
                isVisible: true,
                ...
                shape: DataMarkerType.circle,
                // 设置数据点为圆形
                color:  Color.fromRGBO(65, 52, 249, 1.0),
                // 设置数据点颜色
                height: 3,
                // 设置数据点高度
                width: 3, // 设置数据点宽度
